...
%########################################
%# Tables
\newcolumntype{Z}{>{\RaggedRight\arraybackslash}p{2.6cm}}
\usepackage{threeparttable}
\usepackage{ragged2e}
\usepackage{longtable}
\newcolumntype{Q}{>{\RaggedRight\arraybackslash}p{2.2cm}}
\newcolumntype{T}{>{\RaggedRight\arraybackslash}p{1.3cm}}
\newcolumntype{L}{>{\RaggedRight\arraybackslash}p{2.4cm}} % narrow first column
\newcolumntype{P}{>{\RaggedRight\arraybackslash}p{2.8cm}} % adjust widths as needed

%\newcolumntype{C1}{>{\RaggedRight\arraybackslash}p{0.15\linewidth}} % product
%\newcolumntype{C2}{>{\RaggedRight\arraybackslash}p{0.09\linewidth}} % pack
%\newcolumntype{C3}{>{\RaggedRight\arraybackslash}p{0.10\linewidth}} % price VND
%\newcolumntype{C4}{>{\RaggedRight\arraybackslash}p{0.09\linewidth}} % price USD
%\newcolumntype{C5}{>{\RaggedRight\arraybackslash}p{0.11\linewidth}} % nutrition
%\newcolumntype{C6}{>{\RaggedRight\arraybackslash}p{0.18\linewidth}} % cultures / probiotics