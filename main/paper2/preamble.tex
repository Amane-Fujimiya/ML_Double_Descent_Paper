...
\graphicspath{{media/}{pdf/}}  % organize your images and other figures under media/ and pdf/ folders
...
\microtypesetup{expansion=false}  % disable font expansion for MiKTeX compatibility
...
% Suppress the "ARTICLE" label in the header (class default places it awkwardly)
\makeatletter
\renewcommand*\cup@manuscript{}
\makeatother
...
\renewcommand{\theHcol}{\thesection.\arabic{col}}
\renewcommand{\theHconjecture}{\thesection.\arabic{conjecture}}
\renewcommand{\theHsetting}{\thesection.\arabic{setting}}
\renewcommand{\theHassumption}{\thesection.\arabic{assumption}}
\renewcommand{\theHassume}{\thesection.\arabic{assume}}
\renewcommand{\theHremark}{\thesection.\arabic{remark}}
\renewcommand{\theHhypothesis}{\thesection.\arabic{hypothesis}}
\renewcommand{\theHpostulate}{\thesection.\arabic{postulate}}
\renewcommand{\theHquestion}{\thesection.\arabic{question}}
\renewcommand{\theHnote}{\thesection.\arabic{note}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
