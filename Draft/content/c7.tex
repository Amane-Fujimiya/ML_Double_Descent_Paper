...
\begin{figure}[htb]
	...
	\&\& {T_{11}} \& {M_{11}(T_{11})} \& {P_{11}} \&\& {T_{11}} \& {M_{11}(T_{11})} \& {P_{11}} \&\& \bullet \& {T_{m1}} \& {M_{m2}(T_{m2})} \& {P_{m2}} \\
	{n_{1}^{\to}} \\
	{n_{1}^{\to}} \&\& {T_{12}} \& {M_{12}(T_{12})} \& {P_{12}} \&\& {T_{12}} \& {M_{12}(T_{12})} \& {P_{12}} \&\& \bullet \& {T_{m2}} \& {M_{m2}(T_{m2})} \& {P_{m2}} \\
	{n_{1}^{\to}} \&\&\&\&\&\&\&\&\&\&\&\&\&\&\& {T_{F}} \& {M_{F}(T_{F})} \& {P_{F}} \\
	\vdots \&\& {T_{13}} \& {M_{13}(T_{13})} \& {P_{13}} \&\& {T_{13}} \& {M_{13}(T_{13})} \& {P_{13}} \&\& \bullet \& {T_{m3}} \& {M_{m3}(T_{m3})} \& {P_{m3}} \\
	{n_{i}^{\to}} \&\& \vdots \\
	\&\& {T_{1j}} \& {M_{1j}(T_{1j})} \& {P_{1j}} \&\& {T_{1j}} \& {M_{1j}(T_{1j})} \& {P_{1j}} \&\& \bullet \& {T_{mj}} \& {M_{mj}(T_{mj})} \& {P_{mj}}
	...
	\arrow["\cdots"{description}, from=1-9, to=1-11]
	\arrow["\cdots"{description}, from=1-9, to=5-11]
	\arrow[from=1-11, to=1-12]
	\arrow[from=1-12, to=1-13]
	\arrow[from=1-13, to=1-14]
	\arrow[from=1-14, to=4-16]
	\arrow[from=2-1, to=1-3]
	\arrow[from=2-1, to=3-3]
	\arrow[from=2-1, to=5-3]
	\arrow[from=2-1, to=7-3]
	\arrow[from=3-1, to=1-3]
	\arrow[from=3-1, to=3-3]
	\arrow[from=3-1, to=5-3]
	\arrow[from=3-1, to=7-3]
	\arrow[from=3-3, to=3-4]
	\arrow[from=3-4, to=3-5]
	\arrow[from=3-5, to=1-7]
	\arrow[from=3-5, to=5-7]
	\arrow[from=3-5, to=7-7]
	\arrow[from=3-7, to=3-8]
	\arrow[from=3-8, to=3-9]
	\arrow["\cdots"{description}, from=3-9, to=3-11]
	\arrow[from=3-11, to=3-12]
	\arrow[from=3-12, to=3-13]
	\arrow[from=3-13, to=3-14]
	\arrow[from=3-14, to=4-16]
	\arrow[from=4-1, to=1-3]
	\arrow[from=4-1, to=3-3]
	\arrow[from=4-1, to=5-3]
	\arrow[from=4-1, to=7-3]
	\arrow[from=4-16, to=4-17]
	\arrow[from=4-17, to=4-18]
	\arrow[from=5-3, to=5-4]
	\arrow[from=5-4, to=5-5]
	\arrow[from=5-5, to=3-7]
	\arrow[from=5-7, to=5-8]
	\arrow[from=5-8, to=5-9]
	\arrow["\cdots"{description}, from=5-9, to=3-11]
	\arrow["\cdots"{description}, from=5-9, to=5-11]
	\arrow[from=5-11, to=5-12]
	\arrow[from=5-12, to=5-13]
	\arrow[from=5-13, to=5-14]
	\arrow[from=5-14, to=4-16]
	\arrow[from=6-1, to=1-3]
	\arrow[from=6-1, to=3-3]
	\arrow[from=6-1, to=5-3]
	\arrow[from=6-1, to=7-3]
	\arrow[from=7-3, to=7-4]
	\arrow[from=7-4, to=7-5]
	\arrow[from=7-5, to=5-7]
	\arrow[from=7-5, to=7-7]
	\arrow[from=7-7, to=7-8]
	\arrow[from=7-8, to=7-9]
	\arrow["\cdots"{description}, from=7-9, to=5-11]
	\arrow["\cdots"{description}, from=7-9, to=7-11]
	\arrow[from=7-11, to=7-12]
	\arrow[from=7-12, to=7-13]
	\arrow[from=7-13, to=7-14]
	\arrow[from=7-14, to=4-16]
\end{tikzcd}
    }
